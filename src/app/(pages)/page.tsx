    ...
    <div className="w-full bg-white text-black">
      <section className='flex flex-col h-screen min-h-[700px] max-w-7xl mx-auto bg-white'>
        <div className="flex flex-1 w-full items-center justify-center px-8">
          <div className="flex flex-col items-center gap-8 md:flex-row justify-between flex-1">
            <div className="relative">
              <DrowCirecle 
                strokeWidth="9" 
                className="text-orange animate-line-write w-full"
              />
              <h1 className="absolute inset-0 flex items-center justify-center font-bold leading-relaxed text-[clamp(2.0rem,6vw,5rem)] md:text-[clamp(2.5rem,5vw,3.0rem)]">
      ...
      <section className="flex flex-col max-w-7xl mx-auto justify-start items-start  bg-white p-8 mb-10">
        <div className="relative flex justify-start items-start">
          <DrowCirecle2
            strokeWidth="9" 
            className="text-green animate-line-write w-full"
          />
          <h1 className="absolute inset-0 flex items-center justify-center font-bold leading-relaxed text-[clamp(2.0rem,6vw,5rem)] md:text-[clamp(2.5rem,5vw,3.0rem)]">
            <span className="text-center">
              活動方針
        ...
        <div className="flex w-full flex-row mx-auto text-2xl font-bold text-[#252525] gap-x-14 items-center py-10">
          ...
          <div className="w-2/3">
            <p className="mb-8 text-[clamp(2.0rem,6vw,5rem)] md:text-[clamp(2.5rem,4vw,3.0rem)] leading-normal font-bold">
              みんなのクリエイティブで<br/>
              アプリを創る。
            </p>
      ...
      {/* ------- プロジェクト紹介 ------------------------------------------------------------------------------------------- */}
      {/*  */}
      <section className="flex flex-col bg-[#FFD59A] py-16">
        <div className="flex flex-col max-w-7xl mx-auto w-full px-8">
          <p className="my-20 text-[clamp(2.0rem,6vw,5rem)] md:text-[clamp(2.5rem,4vw,3.5rem)] leading-normal font-bold text-left">
            私たちのプロジェクトを<br/>
            ご紹介します！
          </p>
          ...
          <p className="mt-20 mb-10 text-[clamp(2rem,6vw,5rem)] md:text-[clamp(2.5rem,4vw,3.5rem)] font-bold">
            こんなことも。
          </p>
          <div
            className="
              ...
              pr-[calc((80vw-theme(maxWidth.7xl))/2)]        
      ...
      {/* ------- 言葉 ------------------------------------------------------------------------------------------- */}
      {/*  */}
      <section className="flex flex-col max-w-7xl mx-auto justify-center bg-white my-20 p-8">
        <div className="flex flex-col lg:flex-row items-center justify-center w-full h-auto aspect-[16/9] mx-auto bg-gray-100 rounded-3xl p-8">
          <h2
            className="
               text-[clamp(2.0rem,5vw,3.5rem)]
              font-extrabold leading-snug tracking-tight text-black
            "
          >
            <div className="relative flex flex-row items-center justify-center gap-x-5">
              <DrawLine className="text-green"/>
              <h1 className="absolute inset-0 flex px-32 items-center font-bold leading-relaxed text-[clamp(2.0rem,6vw,5rem)] md:text-[clamp(2.5rem,5vw,3.0rem)]">
                <span className="relative whitespace-nowrap text-white">
                  “やってみたい”
                </span>
              </h1>
              <h1 className="font-bold leading-relaxed text-[clamp(2.0rem,5vw,3.5rem)] text-black">を、</h1>
            </div>
            最初の一歩から応援します。
          </h2>
          <div className="col-span-12 mx-auto mb-8 text-2xl font-bold text-[#252525] md:col-span-5">
            <p className="mb-8">
              未来なんて、
              <br />
              見えないほうがワクワクする。
      ...
      <section className="bg-white max-w-7xl mx-auto">
        <div className="aspect-video">
          <div className="flex h-full w-full flex-col items-center md:flex-row md:items-stretch">
            <div className="my-8 w-[40%] place-content-center place-items-center">
              <svg
                viewBox="0 0 546 276"
                fill="none"
